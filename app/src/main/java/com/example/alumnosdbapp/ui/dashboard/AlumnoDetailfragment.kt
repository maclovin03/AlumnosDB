 ...
 * Use the [AlumnoDetailfragment.newInstance] factory method to
...
class AlumnoDetailfragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_alumno_detailfragment, container, false)
    }
